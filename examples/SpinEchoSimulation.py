...
def run_spin_echo_simulation(lin_grad=0*ppm/cm, quad_grad=0*ppm/cm**2, N_cells=1000, N_ensamble=100, noise_scale=0.2*pc, seed=1, plotting=True, fit_window_scan=True, base_dir="./plots/Bloch_Echo", **kwargs):
    # setup simulation
